<div id="page_partials_form" class="formtabs tab-content">
	...
	<g:each var="partial" in="${partials}">
		<div class="formtab tab-pane">
			...
			<g:textArea name="partial.${partial.symbolName}.content" data-content-css="${assetPath(src: 'spud/content.css')}" class="spud-formatted-editor form-control" value="${partial.content}"/>
		</div>
	</g:each>
</div>
